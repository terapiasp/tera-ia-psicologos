-- Create function to get next day sessions for patient notifications
CREATE OR REPLACE FUNCTION public.get_next_day_sessions_for_patient_notifications(target_date date DEFAULT (CURRENT_DATE + INTERVAL '1 day')::date)
 RETURNS TABLE(
   session_id uuid, 
